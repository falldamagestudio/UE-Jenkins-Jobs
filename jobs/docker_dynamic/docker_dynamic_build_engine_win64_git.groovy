pipelineJob('docker_dynamic/docker_dynamic_build_engine_win64_git') {

  displayName("Docker - Dynamic VM - Build Engine - Win64 - Git")
  ...
  definition {
    cpsScm {
      ...
      scriptPath('Jenkinsfiles/docker_dynamic/docker_dynamic_build_engine_win64_git.groovy')
