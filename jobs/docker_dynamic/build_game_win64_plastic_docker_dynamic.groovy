pipelineJob('docker_dynamic/build_game_win64_plastic_docker_dynamic') {

  displayName("Build Game - Win64 - Plastic - Docker - Dynamic VM")
  ...
  definition {
    cpsScm {
      ...
      scriptPath('Jenkinsfiles/docker_dynamic/build_game_win64_plastic_docker_dynamic.groovy')
