pipelineJob('docker_dynamic/docker_dynamic_build_engine_linux_git') {

  displayName("Docker - Dynamic VM - Build Engine - Linux - Git")
  ...
  definition {
    cpsScm {
      ...
      scriptPath('Jenkinsfiles/docker_dynamic/docker_dynamic_build_engine_linux_git.groovy')
