pipelineJob('k8s/build_game_linux_git_kubernetes') {

  displayName("Build Game - Linux - Git - Kubernetes")
  ...
  definition {
    cpsScm {
      ...
      scriptPath('Jenkinsfiles/kubernetes/build_game_linux_git_kubernetes.groovy')
