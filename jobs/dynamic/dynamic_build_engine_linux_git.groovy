pipelineJob('dynamic/dynamic_build_engine_linux_git') {

  displayName("Dynamic VM - Build Engine - Linux - Git")
  ...
  definition {
    cpsScm {
      ...
      scriptPath('Jenkinsfiles/dynamic/dynamic_build_engine_linux_git.groovy')
