pipelineJob('dynamic/build_game_win64_plastic_dynamic') {

  displayName("Build Game - Win64 - Plastic - Dynamic VM")
  ...
  definition {
    cpsScm {
      ...
      scriptPath('Jenkinsfiles/dynamic/build_game_win64_plastic_dynamic.groovy')
