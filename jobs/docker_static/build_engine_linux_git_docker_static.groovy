pipelineJob('docker_static/build_engine_linux_git_docker_static') {

  displayName("Build Engine - Linux - Git - Docker - Static VM")
  ...
  definition {
    cpsScm {
      ...
      scriptPath('Jenkinsfiles/docker_static/build_engine_linux_git_docker_static.groovy')
