pipelineJob('docker_static/build_game_linux_plastic_docker_static') {

  displayName("Build Game - Linux - Plastic - Docker - Static VM")
  ...
  definition {
    cpsScm {
      ...
      scriptPath('Jenkinsfiles/docker_static/build_game_linux_plastic_docker_static.groovy')
