pipelineJob('docker_static/build_engine_win64_git_docker_static') {

  displayName("Build Engine - Win64 - Git - Docker - Static VM")
  ...
  definition {
    cpsScm {
      ...
      scriptPath('Jenkinsfiles/docker_static/build_engine_win64_git_docker_static.groovy')
